...
// TouristSummaryByCityReq TouristSummaryByCity请求
type TouristSummaryByCityReq struct {
...
// Api 返回API路径
func (r *TouristSummaryByCityReq) Api() string {
	params := url.Values{}
...
// Method 返回HTTP方法
func (r *TouristSummaryByCityReq) Method() string {
	return "GET"
}

// Body 返回请求体
func (r *TouristSummaryByCityReq) Body() []byte {
	return nil

}

// ContentType 返回内容类型
func (r *TouristSummaryByCityReq) ContentType() string {
	return "application/json"
}

// AuthRequired 返回是否需要认证
func (r *TouristSummaryByCityReq) AuthRequired() bool {
	return true
}


// TouristSummaryByCityResp TouristSummaryByCity响应
type TouristSummaryByCityResp struct {
	Total TouristSummary `json:"total,omitempty"`
	List []*TouristSummaryByCityList `json:"list,omitempty"`

}



// TouristSummaryByCityList TouristSummaryByCityList
...
// Params 将TouristSummaryByCityList转换为url.Values
func (p TouristSummaryByCityList) Params(prefix string) url.Values {
	params := url.Values{}
	if p.Province != "" {
