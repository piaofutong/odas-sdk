...
// PreBookingServiceSummaryReq  预订服务汇总请求
...
// PreBookingServiceSummaryResp  预订服务汇总响应
...
type PassedTimeSpanV4Request struct {
	Lid        []int `json:"lid,omitempty"` // 产品id
...
type TimeSpan struct {
	...
	Type         types.TimeFilterType `json:"type,omitempty"` // 0-按天查询，1-按月查询，2-按年查询，默认是按天
...
// PreBookingSummary  预订汇总
type PreBookingSummary struct {
	OrderNum    int64 `json:"orderNum,omitempty"`    // 预定数量
	OrderTicket int64 `json:"orderTicket,omitempty"` // 预定票数
	OrderAmount int64 `json:"orderAmount,omitempty"` // 订单金额
...
// PreBookingServiceSummaryList  预订服务汇总列表
