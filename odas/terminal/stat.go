...
// DeviceJournalStatReq  终端管理 - 出入园实时统计数据查询请求体
...
// DeviceJournalStatResp  终端管理 - 出入园实时统计数据查询响应体
...
// DeviceJournalNodeStatDO  终端管理 - 出入园实时统计节点数据
...
// DeviceJournalNodeItemDO  设备日志节点项目数据
