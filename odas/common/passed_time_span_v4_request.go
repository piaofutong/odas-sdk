...
// PassedTimeSpanV4Request 时间跨度V4请求
...
func (p PassedTimeSpanV4Request) Body() []byte {
	return nil
}

func (p PassedTimeSpanV4Request) Method() string {
	return http.MethodGet
}

func (p PassedTimeSpanV4Request) ContentType() string {
	return "application/x-www-form-urlencoded"
}

func (p PassedTimeSpanV4Request) AuthRequired() bool {
	return true
}
