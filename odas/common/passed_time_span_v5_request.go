...
// PassedTimeSpanV5Request 时间跨度V5请求
type PassedTimeSpanV5Request struct {
...
func (p PassedTimeSpanV5Request) Params(prefix string) url.Values {
	params := url.Values{}
...
func (p PassedTimeSpanV5Request) Body() []byte {
	return nil
}

func (p PassedTimeSpanV5Request) Method() string {
	return http.MethodGet
}

func (p PassedTimeSpanV5Request) ContentType() string {
	return "application/x-www-form-urlencoded"
}

func (p PassedTimeSpanV5Request) AuthRequired() bool {
	return true
}
