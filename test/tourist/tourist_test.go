...
import (
	...
	touristV5 "github.com/piaofutong/odas-sdk/odas/tourist"
	...
	"gitlab.12301.test/gopkg/idss-go-sdk/pb/tourist"
...
// 	if len(grpcResp.Inside) == 0 {
// 		t.Fatalf("测试失败，数据返回为空")
// 	}

// 	if len(grpcResp.Outside) == 0 {
// 		t.Fatalf("测试失败，数据返回为空")
// 	}
